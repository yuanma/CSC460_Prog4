...
public final class addNewPart_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t<title>Add New Part</title>\n");
      out.write("\t\t<style>\n");
      out.write("\t\t\tbutton {\n");
      ...
      out.write("\t</head>\n");
      out.write("\t<body>\n");
      out.write("\t<div id=\"addNewPartBox\">\n");
      out.write("\n");
      out.write("\t<center>\n");
      out.write("\t\t<h2>Add New Part</h2>\n");
      out.write("\t\t<form action=\"addNewPart.jsp\" method=\"post\">\n");
      out.write("\t\t\t<fieldset id = \"field1\">\n");
      out.write("\t\t\t\t<legend>Enter Information:</legend>\t\t\t\t\n");
      out.write("\t\t\t\t<h3>Enter Part Name: \n");
      out.write("\t\t\t\t\t<input type=\"text\" name=\"partName\" value=\"\" onkeypress=\"this.style.width = ((this.value.length + 2) * 8) + 'px';\">\n");
      out.write("\t\t\t\t</h3>\n");
